	...
	*/
	...
	function postLogin() {		
		...
		if ($auth) {
			...
			$grav_profile_pic = "http://www.gravatar.com/avatar/" . md5( strtolower( trim( $email ) ) ) . "?d=" . urlencode( $default ) . "&s=90";
			$grav_sidebar_pic = "http://www.gravatar.com/avatar/" . md5( strtolower( trim( $email ) ) ) . "?d=" . urlencode( $default ) . "&s=30";
			$user = User::find ( Auth::user ()->id );	
			Session::put ( 'profile_pic', $grav_profile_pic );
			Session::put ( 'sidebar_pic', $grav_sidebar_pic );
