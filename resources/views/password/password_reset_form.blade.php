  ...
  <body class="login-page">
    <div class="login-box">
      ...
      <div class="login-box-body">
        ...
        {!! Form::open(array('url' => 'password/save-password')) !!}
        {!! Session::get('flash_message') !!}
          ...
          <div class="form-group has-feedback">
            {!! Form::password('confirm_password', array('class'=>'form-control', 'placeholder'=>'Confirm Password'), Input::old('confirm_password')) !!}
