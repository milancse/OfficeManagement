			...
			<div class="box-body">
				<div class="row">
					...
					<div class="form-group col-md-6 <?= $errors->first('office_time_zone') ? "has-error" : "" ?>">
						...
						{!!Form::select('office_time_zone',config('constants.office_time_zone'),null,array('class'=>'form-control','id'=>'zone_select2'))!!}
				...
				<div class="row">
					<div class="col-md-6">
						...
						<div class="form-group col-md-6 ">
							{!!Form::label('slogan','Company Slogan')!!}
							{!!Form::text('slogan',Input::old('slogan'),array('class'=>'form-control'))!!}
					
						</div>
					</div>
					{!! Form::checkbox('active', '1','checked',array('form-group')) !!} Active.
				</div>
