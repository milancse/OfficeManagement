		...
		<div class="box box-info">
			...
			<div class="box-body">
				...
				<div class="row">
					...
					<div class="col-md-6 <?php echo $errors->first('gender') ? "has-error" : ""; ?> has-feedback">
                       	<div class="form-group">
							<label for="gender">Gender </label>
						</div>
						<div class="form-group">
							<div class="col-md-3"><h4> {!!Form::radio('gender', 'male', true)!!}  Male</h4>	</div>	
							<div class="col-md-3"><h4>  {!!Form::radio('gender', 'female', true)!!}  Female</h4></div>
						</div>        
