...
<link href="{{ URL::asset('bootstrap_wysihtml5/bootstrap-wysihtml5.css')}}" rel="stylesheet" type="text/css" />
...
<link rel="stylesheet" href="{{ URL::asset('css/skins/_all-skins.min.css') }}" rel="stylesheet" type="text/css" />
